/// <reference path="../jquery-2.0.1-vsdoc.js" />
...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        datetimeformat: 'yyyy-MM-dd hh:mm:ss', //默认时间显示格式
    ...
    {
        function getFormatDate(date, datetimeformat)
        {
            var g = this, p = this.options;
            if (isNaN(date)) return null;
        ...
        if (value instanceof Date)
        {
            var format = column.format || this.options.datetimeformat || "yyyy-MM-dd";
            return getFormatDate(value, format);
        }
        else
        {
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        _addNewRecord: function (o, previd, pid)
        {
            ...
            if ((o[p.statusName] != "add") && (o[p.statusName] != "update"))

...
namespace Logistics.EFRepository.Mapping
{
    ...
    internal partial class ProductModule_Mapping : EntityTypeConfiguration<ProductModule>
    {
        public ProductModule_Mapping()
        {					
    		this.HasKey(t => t.Id);		
    		this.ToTable("ProductModules");
    		...
    		this.HasRequired(t => t.Product).WithMany(t => t.ProductModules).HasForeignKey(d => d.Proid);
    	}
    }
}
